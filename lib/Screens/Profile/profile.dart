...
final List adds = [
  ...
  },
  {
    ...
    'subtitle': "Passport to anywhere with Global Sight Dating",
  },
  {
    'icon': Icons.vpn_key,
    'color': Colors.orange,
      ...
      body: Container(
        ...
        child: SingleChildScrollView(
          child: Column(mainAxisAlignment: MainAxisAlignment.center, children: <Widget>[
            ...
            Text(
              widget.currentUser.name != null && widget.currentUser.age != null ? "${widget.currentUser.name}, ${widget.currentUser.age}" : "",
                            ...
                            FloatingActionButton(
                                ...
                                onPressed: () {
                                  Navigator.push(
                                      context,
                                      CupertinoPageRoute(
                                          maintainState: true, builder: (context) => Settings(widget.currentUser, widget.isPuchased, widget.items)));
                                }),
                            Padding(
                              padding: const EdgeInsets.all(8.0),
                              child: Text(
            ...
            Padding(
              ...
              child: InkWell(
                child: Container(
                    ...
                    child: Center(
                        child: Text(
                      widget.isPuchased && widget.purchases != null ? "Check Payment Details" : "Subscribe Plan",
                ...
                onTap: () async {
                  if (widget.isPuchased && widget.purchases != null) {
                    ...
                    Navigator.push(
                      context,
                      CupertinoPageRoute(builder: (context) => Subscription(widget.currentUser, null, widget.items)),
                    );
                  }
