...
class _SettingsState extends State<Settings> {
  ...
  Future updateData() async {
    FirebaseFirestore.instance.collection("Users").doc(widget.currentUser.id).set(changeValues);
    // lastVisible = null;
  ...
  void initState() {
    ...
    //   ..load()
    //   ..show();
    freeR = widget.items['free_radius'] != null ? int.parse(widget.items['free_radius']) : 1000;
              ...
              children: <Widget>[
                ...
                Padding(
                  ...
                  child: InkWell(
                    ...
                    onTap: () {
                      Share.share('check out my Dating App', //Replace with your dynamic link and msg for invite users
  ...
  Future _deleteUser(auth.User user) async {
