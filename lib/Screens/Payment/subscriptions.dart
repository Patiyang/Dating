...
class _SubscriptionState extends State<Subscription> {
                ...
                child: Column(
                  ...
                  children: [
                    ...
                    ListTile(
                      ...
                      title: Text(
                        "Search users around Unlimited kms.",
                        style: TextStyle(
                  ...
                  child: InkWell(
                    ...
                    onTap: () async {
                      ...
                      if (selectedProduct != null)
                        ...
                        CustomSnackbar.snackbar("You must choose a subscription to continue.", _scaffoldKey, context);
                      }
                    },
                  ),
                )),
              ...
              child: Row(
                ...
                children: <Widget>[
                  GestureDetector(
                    ...
                    onTap: () => launch("http://planethello.com/globalsight/GLobalSightDatingPrivacyPolicy.html"),
                  ),
                  GestureDetector(
                    child: Text(
                      "Terms of Use",
                    ...
                    onTap: () => launch("http://planethello.com/globalsight/GlobalSightDatingTermsorUse.html"),
                  )
                ],
              ),
            ),
  ...
  Widget productList({
    ...
    return AnimatedContainer(
      ...
      decoration: selectedProduct == product
          ? BoxDecoration(
              shape: BoxShape.rectangle, borderRadius: BorderRadius.circular(10), color: Colors.white, border: Border.all(width: 2, color: primaryColor))
          : null,
  ...
  Future _getpastPurchases() async {
    ...
    if (purchases.length > 0) {
      ...
      print('you have no previous purchases for this app');
      return purchases;
    }
  }
