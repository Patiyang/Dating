...
class _ChatPageState extends State<ChatPage> {
                          ...
                          Padding(
                            ...
                            child: Text(
                                documentSnapshot.get('time') != null
                                    ? DateFormat.yMMMd()
                                        .add_jm()
                                        .format(documentSnapshot.get('time')
                                            .toDate())
                                        .toString()
                                    : "",
                                style: TextStyle(
                          ...
                          Text(doc.get("time")!= null
                              ? "${doc.get('text')} : " +
                                  DateFormat.yMMMd()
                                      ...
                                      .toString() +
                                  " by ${doc.get('time') == widget.sender.id ? "You" : "${widget.second.name}"}"
                              : "")
                        ]
                      : doc.get('time') != widget.sender.id
                                ...
                                onPressed: () async {
                                  ...
                                  if (isBlocked &&
                                    ...
                                    CustomSnackbar.snackbar(
                                        "You can't unblock", _scaffoldKey, context);
                                  }
                                },
                                child: Text('Yes'),
                              ),
              ...
              Container(
                ...
                child: IconButton(
                    ...
                    onPressed: () async {
                      ...
                      await uploadTask.whenComplete(()async { String fileUrl = await storageReference.getDownloadURL();
  ...
  Future<void> onJoin(callType) async {
    if (!isBlocked) {
      ...
      CustomSnackbar.snackbar("Blocked !", _scaffoldKey, context);
    }
  }
}
