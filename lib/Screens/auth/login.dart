...
import 'package:hookup4u/util/custom_button.dart';
import 'package:url_launcher/url_launcher.dart';

class Login extends StatelessWidget {
  static const your_client_id = '451413119426649';
  final FirebaseAuth _auth = FirebaseAuth.instance;
  static const your_redirect_url = 'https://dating-app-c1796.firebaseapp.com/__/auth/handler';
                ...
                children: <Widget>[
                  ClipPath(
                    ...
                    child: Container(
                      ...
                      height: 280,
                      decoration: BoxDecoration(gradient: LinearGradient(colors: [darkPrimaryColor, primaryColor.withOpacity(.15)])),
                    ),
                  ),
                  ClipPath(
                    ...
                    child: Container(
                      ...
                      width: double.infinity,
                      height: 280,
                      decoration: BoxDecoration(gradient: LinearGradient(colors: [darkPrimaryColor, primaryColor.withOpacity(.2)])),
                    ),
                  ),
                  ClipPath(
                    ...
                    child: Container(
                      ...
                      width: double.infinity,
                      height: 280,
                      decoration: BoxDecoration(gradient: LinearGradient(colors: [primaryColor, primaryColor])),
                    ),
                  ),
                ],
              ),
...
our Privacy Policy and Cookies Policy.""",
                        ...
                        child: Container(
                            decoration: BoxDecoration(
                                ...
                                gradient: LinearGradient(
                                    ...
                                    colors: [primaryColor.withOpacity(.5), primaryColor.withOpacity(.8), primaryColor, primaryColor])),
                ...
                Platform.isIOS
                    ? Padding(
                        ...
                        child: i.AppleSignInButton(
                          ...
                          onPressed: () async {
                            final User currentUser = await handleAppleLogin(context).catchError((onError) {
                ...
                //     child: Center(child: Text("LOG IN WITH PHONE NUMBER", style: TextStyle(color: primaryColor, fontWeight: FontWeight.bold))),
                //   ),
                //   borderSide: BorderSide(width: 1, style: BorderStyle.solid, color: primaryColor),
              ...
              Row(
                ...
                children: <Widget>[
                  GestureDetector(
                    ...
                    onTap: () => _launchURL("http://planethello.com/globalsight/GLobalSightDatingPrivacyPolicy.html"),
                  ),
                  Container(
  ...
  Future navigationCheck(User currentUser, context) async {
    ...
    await FirebaseFirestore.instance.collection('Users').where('userId', isEqualTo: currentUser.uid).get().then((QuerySnapshot snapshot) async {
  ...
  Future<User> handleAppleLogin(BuildContext context) async {
    User user;
    if (await i.AppleSignIn.isAvailable()) {
      try {
        final i.AuthorizationResult result = await i.AppleSignIn.performRequests([
  ...
  await FirebaseFirestore.instance.collection("Users").doc(user.uid).set(
    {
      ...
      'Pictures': FieldValue.arrayUnion(
          [user.photoURL ?? 'https://encrypted-tbn0.gstatic.com/images?q=tbn:ANd9GcSxUC64VZctJ0un9UBnbUKtj-blhw02PeDEQIMOqovc215LWYKu&s']),
