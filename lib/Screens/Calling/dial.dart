...
class _DialCallState extends State<DialCall> {
  ...
  _addCallingData() async {
    await callRef.doc(widget.receiver.id).set({
    ...
    return Scaffold(
      ...
      body: Center(
          child: StreamBuilder<DocumentSnapshot>(
              stream: callRef.doc(widget.receiver.id).snapshots(),
                          ...
                          return Column(
                            ...
                            children: <Widget>[
                              ...
                              ElevatedButton.icon(
                                  ...
                                  onPressed: () async {
                                    await callRef.doc(widget.receiver.id).update(
                      ...
                      case "Decline":
                        {
                          return Column(
                            ...
                            crossAxisAlignment: CrossAxisAlignment.center,
                            children: <Widget>[
                              Text("${widget.receiver.name} is Busy", style: TextStyle(fontSize: 25, fontWeight: FontWeight.bold)),
                              ElevatedButton.icon(
                                  style: ButtonStyle(
                                    backgroundColor: MaterialStateProperty.all<Color>(primaryColor),
                                  ),
                      ...
                      case "Not-answer":
                        {
                          return Column(
                            ...
                            crossAxisAlignment: CrossAxisAlignment.center,
                            children: <Widget>[
                              Text("${widget.receiver.name} is Not-answering", style: TextStyle(fontSize: 25, fontWeight: FontWeight.bold)),
                              ElevatedButton.icon(
                                  style: ButtonStyle(
                                    backgroundColor: MaterialStateProperty.all<Color>(primaryColor),
                                  ),
