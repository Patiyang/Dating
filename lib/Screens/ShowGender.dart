        ...
        children: <Widget>[
          ...
          Center(
            child: Column(
              ...
              children: <Widget>[
                CustomFlatButton(
                  text: "MEN",color:  man ? primaryColor : secondryColor,
                  callback: () {
                    setState(() {
                      woman = false;
                      man = true;
                ...
                Padding(
                  ...
                  CustomFlatButton(
                    text: "WOMEN",color: woman ? primaryColor : secondryColor,
                    callback: () {
                      setState(() {
                        woman = true;
                        man = false;
                ...
                CustomFlatButton(
                  text: "EVERYONE",color: eyeryone ? primaryColor : secondryColor,
                  callback:  () {
                    setState(() {
                      woman = false;
                      man = false;
                    ...
                    child: InkWell(
                      ...
                      onTap: () {
                        CustomSnackbar.snackbar(
                            "Please select one", _scaffoldKey, context);
                      },
                    ),
                  ),
                )
